...
import 'package:app1/src/pages/restaurant/orders/map/restaurant_orders_map_controller.dart';
import 'package:flutter/material.dart';
import 'package:app1/src/pages/client/address/map/client_address_map_controller.dart';
import 'package:get/get.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';

class RestaurantOrdersMapPage extends StatelessWidget {
  //RestaurantOrdersMapController con = Get.put(RestaurantOrdersMapController());
  ...
  Widget _cardOrderInfo(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          _listTileAddress(con.order.address?.neighborhood ?? '', 'Barrio',
              Icons.my_location),
          _listTileAddress(
