...
class RestaurantOrdersMapController extends GetxController {
  ...
  CameraPosition initialPosition =
      CameraPosition(target: LatLng(20.7123519, -103.4113297), zoom: 14);
  ...
  void updateLocation() async {
    ...
    try {
      ...
      LatLng to = LatLng(
          order.address?.lat ?? 20.7123519, order.address?.lng ?? -103.4113297);
